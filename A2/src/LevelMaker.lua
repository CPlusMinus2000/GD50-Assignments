...
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            -- randomly determine whether or not to lock bricks
            local lock = math.random(20) == 19 and true or false

            if lock and numLocked > 0 then
                b.color = 6
                b.tier = 0
                b.locked = true
